...
- **Drafting model:** Claude drafts from sources with a source map appendix; Ryan does the voice/color pass; a humanizer (de-AI-ify) pass on prose; claim verification; publish (`draft: false`, featured flags as decided).
