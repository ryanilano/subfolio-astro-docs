...
- **[Getting Started](/subfolio-astro-docs/docs/getting-started/)** — install, run,
  point the loader at your content, and produce your first build.
- **[Conventions Reference](/subfolio-astro-docs/docs/conventions/)** — the full
  naming-convention system, each with real before/after examples.
